...
export class PornSetting extends React.Component<IPornSettingProps, IPornSettingState> {
  ...
  loadBlacklist() {
    ...
    axios
      .get(`https://e621.net/users/${this.props.credentials!.login}.json`, config)
      .then((response: AxiosResponse<E621User>) => {
              ...
              <>
                <label>
                  ...
                  <input
                    type="checkbox"
                    checked
                    onChange={this.clearCredentials}
                  />
                </label>
                <br />
                <em>Logged in. You can use votedup:me &amp; global blacklisted posts.</em>
              </>
            ) : (
              <>
                <label>
                ...
                <em>Login to use votedup:me &amp; global blacklisted posts.</em>
                {this.state.addCredentials ? (
                  <>
                    ...
                    <em>(found in <a href="https://e621.net/users/home">your account</a> under "Manage API Access")</em>
                    <button onClick={this.saveCredentials}>Save credentials</button>
                    {this.state.credentialsError != null ? (
                      <span className="PornSetting__error">{this.state.credentialsError}</span>
                    ) : null}
                  </>
                ) : null}
              </>
              ...
              <>
                ...
                <label>
                  ...
                  <textarea
                    ...
                    onChange={e => this.setState({ blacklistTagsString: e.target.value })}
                  ></textarea>
                  <em>
                  ...
                  {this.props.credentials ? (
                    <button onClick={this.loadBlacklist}>Reload user blacklist</button>
                  ) : null}
                </label>
              </>
            ) : null}
